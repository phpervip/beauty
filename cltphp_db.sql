...
(1,'admin','0192023a7bbd73250516f069df18b500',1,'1109305987@qq.com','','18792402229','127.0.0.1',1482132862,'0',1,'/uploads/20180625/f266169c2956429d9aaea6cf6f1e51cb.jpg');
...
(38,3,1,'admin','关于CLTPHP的一些琐碎事','关于CLTPHP的一些琐碎事 cltphp cltphp内容管理系统 php','CLTPHP的目的是 让所有人都能 高效 简洁 的建立网站，虽然世界上有成千上万的建站系统，但CLTPHP会告诉你，真正高效的建站系统是什么样的。','<p>CLTPHP是开源的</p><p><a href=\"http://demo.cltphp.com\" target=\"_self\" title=\"CLTPHP演示站\">CLTPHP演示站</a>的后台用户名：admin &nbsp;密码：admin123</p><p>版本更新包的后台用户名：admin &nbsp;密码：admin123</p><p>新版本发布，请登录后台，清空缓存后再打开前台，不然，前台可能会报错。</p><p><span style=\"color: rgb(149, 55, 52);\">如果没有意外（睡眼忪惺）的时候，以上永久不变。</span></p>','0',1,'1',0,'',0,0,1267,1505264319,1515748920,'CLTPHP','http://www.cltphp.com/','',''),
...
(2,'管理员',1,'0,1,2,270,15,16,145,17,181,18,111,3,5,127,128,4,129,189,190,239,241,242,7,9,14,13,27,29,161,163,164,162,38,167,182,169,166,28,48,31,32,45,170,171,175,174,173,46,176,183,179,178,196,197,202,252,203,205,204,257,272,206,207,212,208,260,267,269,',1465114224),
...
(278,'Feast/index','节日气氛',1,1,1,'','',267,50,1532416207,NULL,1);
...
(5,'CLTPHP动态','news2','news/',1,2,'article','0,1','5',0,'CLTPHP动态','CLTPHP动态','CLTPHP动态',0,0,1,0,'',0,'','','',5,'1,2,3',0,0,1),
(6,'相关知识 ','news','news/',1,2,'article','0,1','6',0,'CLTPHP相关知识','CLTPHP相关知识','CLTPHP相关知识',0,0,1,0,'',0,'','','',0,'',0,0,1),
(14,'文件下载','download','',0,5,'download','0','14',0,'测试下载','测试下载','测试下载',0,0,1,0,'',0,'','','',10,'1,2',0,0,0);
...
(116,19,'hits','点击次数','',0,0,8,'','','','number','array (\n  \'size\' => \'10\',\n  \'numbertype\' => \'1\',\n  \'decimaldigits\' => \'0\',\n  \'default\' => \'0\',\n)',1,'',8,0,0),
(115,19,'title','标题','',1,1,80,'','标题必须为1-80个字符','','title','array (\n  \'thumb\' => \'1\',\n  \'style\' => \'1\',\n  \'size\' => \'55\',\n)',1,'',2,1,1),
(118,19,'template','模板','',0,0,0,'','','','template','',1,'',99,1,1),
(119,19,'status','状态','',0,0,0,'','','','radio','array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)',1,'',98,1,1),
(117,19,'createtime','发布时间','',1,0,0,'date','','createtime','datetime','',1,'',97,1,1);
...
(1,'CLTPHP','http://cltshow.test/','CLTPHP','CLTPHP,CLTPHP内容管理系统,php','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。','陕ICP备15008093号-3','2015-2020','西安市雁塔区','18792402229','1109305987@qq.com','/uploads/20180608/55624159eb051a6c5e9bfadff49bf731.png','open','open');
...
/*Table structure for table `clt_test` */
